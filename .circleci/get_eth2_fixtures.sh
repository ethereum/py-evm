...
if [ ! -d "./eth2-fixtures/tests" ]; then
  ...
  mkdir -p eth2-fixtures/tests
  tar zxvf general.tar.gz -C ./eth2-fixtures/tests
  tar zxvf mainnet.tar.gz -C ./eth2-fixtures/tests
  tar zxvf minimal.tar.gz -C ./eth2-fixtures/tests
fi
