...
state_item_formatter = combine_argument_formatters(
...
state_post_formatter = eth_utils.curried.apply_formatters_to_dict({"hash": encode_hex})


filled_state_test_formatter = cytoolz.curried.valmap(
...
call_creates_formatter = eth_utils.curried.apply_formatter_to_array(
    call_create_item_formatter
)

filled_vm_test_formatter = cytoolz.curried.valmap(
    eth_utils.curried.apply_formatters_to_dict(
        {
            "env": environment_formatter,
            "pre": state_formatter,
