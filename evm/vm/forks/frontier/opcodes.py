...
FRONTIER_OPCODES = {
    ...
    opcode_values.STOP: as_opcode(
        logic_fn=flow.stop, mnemonic=mnemonics.STOP, gas_cost=constants.GAS_ZERO
    ),
    opcode_values.ADD: as_opcode(
        logic_fn=arithmetic.add, mnemonic=mnemonics.ADD, gas_cost=constants.GAS_VERYLOW
    ),
    opcode_values.MUL: as_opcode(
        logic_fn=arithmetic.mul, mnemonic=mnemonics.MUL, gas_cost=constants.GAS_LOW
    ),
    opcode_values.SUB: as_opcode(
        logic_fn=arithmetic.sub, mnemonic=mnemonics.SUB, gas_cost=constants.GAS_VERYLOW
    ),
    opcode_values.DIV: as_opcode(
        logic_fn=arithmetic.div, mnemonic=mnemonics.DIV, gas_cost=constants.GAS_LOW
    ),
    opcode_values.SDIV: as_opcode(
        logic_fn=arithmetic.sdiv, mnemonic=mnemonics.SDIV, gas_cost=constants.GAS_LOW
    ),
    opcode_values.MOD: as_opcode(
        logic_fn=arithmetic.mod, mnemonic=mnemonics.MOD, gas_cost=constants.GAS_LOW
    ),
    opcode_values.SMOD: as_opcode(
        logic_fn=arithmetic.smod, mnemonic=mnemonics.SMOD, gas_cost=constants.GAS_LOW
    ),
    ...
    opcode_values.LT: as_opcode(
        logic_fn=comparison.lt, mnemonic=mnemonics.LT, gas_cost=constants.GAS_VERYLOW
    ),
    opcode_values.GT: as_opcode(
        logic_fn=comparison.gt, mnemonic=mnemonics.GT, gas_cost=constants.GAS_VERYLOW
    ),
    opcode_values.SLT: as_opcode(
        logic_fn=comparison.slt, mnemonic=mnemonics.SLT, gas_cost=constants.GAS_VERYLOW
    ),
    opcode_values.SGT: as_opcode(
        logic_fn=comparison.sgt, mnemonic=mnemonics.SGT, gas_cost=constants.GAS_VERYLOW
    ),
    opcode_values.EQ: as_opcode(
        logic_fn=comparison.eq, mnemonic=mnemonics.EQ, gas_cost=constants.GAS_VERYLOW
    ),
    ...
    opcode_values.OR: as_opcode(
        logic_fn=comparison.or_op, mnemonic=mnemonics.OR, gas_cost=constants.GAS_VERYLOW
    ),
    opcode_values.XOR: as_opcode(
        logic_fn=comparison.xor, mnemonic=mnemonics.XOR, gas_cost=constants.GAS_VERYLOW
    ),
    ...
    opcode_values.SHA3: as_opcode(
        logic_fn=sha3.sha3, mnemonic=mnemonics.SHA3, gas_cost=constants.GAS_SHA3
    ),
    #
    ...
    opcode_values.ORIGIN: as_opcode(
        logic_fn=context.origin, mnemonic=mnemonics.ORIGIN, gas_cost=constants.GAS_BASE
    ),
    opcode_values.CALLER: as_opcode(
        logic_fn=context.caller, mnemonic=mnemonics.CALLER, gas_cost=constants.GAS_BASE
    ),
    ...
    opcode_values.NUMBER: as_opcode(
        logic_fn=block.number, mnemonic=mnemonics.NUMBER, gas_cost=constants.GAS_BASE
    ),
    ...
    opcode_values.POP: as_opcode(
        logic_fn=stack.pop, mnemonic=mnemonics.POP, gas_cost=constants.GAS_BASE
    ),
    opcode_values.MLOAD: as_opcode(
        logic_fn=memory.mload, mnemonic=mnemonics.MLOAD, gas_cost=constants.GAS_VERYLOW
    ),
    ...
    opcode_values.SLOAD: as_opcode(
        logic_fn=storage.sload, mnemonic=mnemonics.SLOAD, gas_cost=constants.GAS_SLOAD
    ),
    opcode_values.SSTORE: as_opcode(
        logic_fn=storage.sstore, mnemonic=mnemonics.SSTORE, gas_cost=constants.GAS_NULL
    ),
    opcode_values.JUMP: as_opcode(
        logic_fn=flow.jump, mnemonic=mnemonics.JUMP, gas_cost=constants.GAS_MID
    ),
    opcode_values.JUMPI: as_opcode(
        logic_fn=flow.jumpi, mnemonic=mnemonics.JUMPI, gas_cost=constants.GAS_HIGH
    ),
    opcode_values.PC: as_opcode(
        logic_fn=flow.pc, mnemonic=mnemonics.PC, gas_cost=constants.GAS_BASE
    ),
    opcode_values.MSIZE: as_opcode(
        logic_fn=memory.msize, mnemonic=mnemonics.MSIZE, gas_cost=constants.GAS_BASE
    ),
    opcode_values.GAS: as_opcode(
        logic_fn=flow.gas, mnemonic=mnemonics.GAS, gas_cost=constants.GAS_BASE
    ),
    ...
    opcode_values.PUSH1: as_opcode(
        logic_fn=stack.push1, mnemonic=mnemonics.PUSH1, gas_cost=constants.GAS_VERYLOW
    ),
    opcode_values.PUSH2: as_opcode(
        logic_fn=stack.push2, mnemonic=mnemonics.PUSH2, gas_cost=constants.GAS_VERYLOW
    ),
    opcode_values.PUSH3: as_opcode(
        logic_fn=stack.push3, mnemonic=mnemonics.PUSH3, gas_cost=constants.GAS_VERYLOW
    ),
    opcode_values.PUSH4: as_opcode(
        logic_fn=stack.push4, mnemonic=mnemonics.PUSH4, gas_cost=constants.GAS_VERYLOW
    ),
    opcode_values.PUSH5: as_opcode(
        logic_fn=stack.push5, mnemonic=mnemonics.PUSH5, gas_cost=constants.GAS_VERYLOW
    ),
    opcode_values.PUSH6: as_opcode(
        logic_fn=stack.push6, mnemonic=mnemonics.PUSH6, gas_cost=constants.GAS_VERYLOW
    ),
    opcode_values.PUSH7: as_opcode(
        logic_fn=stack.push7, mnemonic=mnemonics.PUSH7, gas_cost=constants.GAS_VERYLOW
    ),
    opcode_values.PUSH8: as_opcode(
        logic_fn=stack.push8, mnemonic=mnemonics.PUSH8, gas_cost=constants.GAS_VERYLOW
    ),
    opcode_values.PUSH9: as_opcode(
        logic_fn=stack.push9, mnemonic=mnemonics.PUSH9, gas_cost=constants.GAS_VERYLOW
    ),
    opcode_values.PUSH10: as_opcode(
        logic_fn=stack.push10, mnemonic=mnemonics.PUSH10, gas_cost=constants.GAS_VERYLOW
    ),
    opcode_values.PUSH11: as_opcode(
        logic_fn=stack.push11, mnemonic=mnemonics.PUSH11, gas_cost=constants.GAS_VERYLOW
    ),
    opcode_values.PUSH12: as_opcode(
        logic_fn=stack.push12, mnemonic=mnemonics.PUSH12, gas_cost=constants.GAS_VERYLOW
    ),
    opcode_values.PUSH13: as_opcode(
        logic_fn=stack.push13, mnemonic=mnemonics.PUSH13, gas_cost=constants.GAS_VERYLOW
    ),
    opcode_values.PUSH14: as_opcode(
        logic_fn=stack.push14, mnemonic=mnemonics.PUSH14, gas_cost=constants.GAS_VERYLOW
    ),
    opcode_values.PUSH15: as_opcode(
        logic_fn=stack.push15, mnemonic=mnemonics.PUSH15, gas_cost=constants.GAS_VERYLOW
    ),
    opcode_values.PUSH16: as_opcode(
        logic_fn=stack.push16, mnemonic=mnemonics.PUSH16, gas_cost=constants.GAS_VERYLOW
    ),
    opcode_values.PUSH17: as_opcode(
        logic_fn=stack.push17, mnemonic=mnemonics.PUSH17, gas_cost=constants.GAS_VERYLOW
    ),
    opcode_values.PUSH18: as_opcode(
        logic_fn=stack.push18, mnemonic=mnemonics.PUSH18, gas_cost=constants.GAS_VERYLOW
    ),
    opcode_values.PUSH19: as_opcode(
        logic_fn=stack.push19, mnemonic=mnemonics.PUSH19, gas_cost=constants.GAS_VERYLOW
    ),
    opcode_values.PUSH20: as_opcode(
        logic_fn=stack.push20, mnemonic=mnemonics.PUSH20, gas_cost=constants.GAS_VERYLOW
    ),
    opcode_values.PUSH21: as_opcode(
        logic_fn=stack.push21, mnemonic=mnemonics.PUSH21, gas_cost=constants.GAS_VERYLOW
    ),
    opcode_values.PUSH22: as_opcode(
        logic_fn=stack.push22, mnemonic=mnemonics.PUSH22, gas_cost=constants.GAS_VERYLOW
    ),
    opcode_values.PUSH23: as_opcode(
        logic_fn=stack.push23, mnemonic=mnemonics.PUSH23, gas_cost=constants.GAS_VERYLOW
    ),
    opcode_values.PUSH24: as_opcode(
        logic_fn=stack.push24, mnemonic=mnemonics.PUSH24, gas_cost=constants.GAS_VERYLOW
    ),
    opcode_values.PUSH25: as_opcode(
        logic_fn=stack.push25, mnemonic=mnemonics.PUSH25, gas_cost=constants.GAS_VERYLOW
    ),
    opcode_values.PUSH26: as_opcode(
        logic_fn=stack.push26, mnemonic=mnemonics.PUSH26, gas_cost=constants.GAS_VERYLOW
    ),
    opcode_values.PUSH27: as_opcode(
        logic_fn=stack.push27, mnemonic=mnemonics.PUSH27, gas_cost=constants.GAS_VERYLOW
    ),
    opcode_values.PUSH28: as_opcode(
        logic_fn=stack.push28, mnemonic=mnemonics.PUSH28, gas_cost=constants.GAS_VERYLOW
    ),
    opcode_values.PUSH29: as_opcode(
        logic_fn=stack.push29, mnemonic=mnemonics.PUSH29, gas_cost=constants.GAS_VERYLOW
    ),
    opcode_values.PUSH30: as_opcode(
        logic_fn=stack.push30, mnemonic=mnemonics.PUSH30, gas_cost=constants.GAS_VERYLOW
    ),
    opcode_values.PUSH31: as_opcode(
        logic_fn=stack.push31, mnemonic=mnemonics.PUSH31, gas_cost=constants.GAS_VERYLOW
    ),
    opcode_values.PUSH32: as_opcode(
        logic_fn=stack.push32, mnemonic=mnemonics.PUSH32, gas_cost=constants.GAS_VERYLOW
    ),
    #
    ...
    opcode_values.SWAP1: as_opcode(
        logic_fn=swap.swap1, mnemonic=mnemonics.SWAP1, gas_cost=constants.GAS_VERYLOW
    ),
    opcode_values.SWAP2: as_opcode(
        logic_fn=swap.swap2, mnemonic=mnemonics.SWAP2, gas_cost=constants.GAS_VERYLOW
    ),
    opcode_values.SWAP3: as_opcode(
        logic_fn=swap.swap3, mnemonic=mnemonics.SWAP3, gas_cost=constants.GAS_VERYLOW
    ),
    opcode_values.SWAP4: as_opcode(
        logic_fn=swap.swap4, mnemonic=mnemonics.SWAP4, gas_cost=constants.GAS_VERYLOW
    ),
    opcode_values.SWAP5: as_opcode(
        logic_fn=swap.swap5, mnemonic=mnemonics.SWAP5, gas_cost=constants.GAS_VERYLOW
    ),
    opcode_values.SWAP6: as_opcode(
        logic_fn=swap.swap6, mnemonic=mnemonics.SWAP6, gas_cost=constants.GAS_VERYLOW
    ),
    opcode_values.SWAP7: as_opcode(
        logic_fn=swap.swap7, mnemonic=mnemonics.SWAP7, gas_cost=constants.GAS_VERYLOW
    ),
    opcode_values.SWAP8: as_opcode(
        logic_fn=swap.swap8, mnemonic=mnemonics.SWAP8, gas_cost=constants.GAS_VERYLOW
    ),
    opcode_values.SWAP9: as_opcode(
        logic_fn=swap.swap9, mnemonic=mnemonics.SWAP9, gas_cost=constants.GAS_VERYLOW
    ),
    opcode_values.SWAP10: as_opcode(
        logic_fn=swap.swap10, mnemonic=mnemonics.SWAP10, gas_cost=constants.GAS_VERYLOW
    ),
    opcode_values.SWAP11: as_opcode(
        logic_fn=swap.swap11, mnemonic=mnemonics.SWAP11, gas_cost=constants.GAS_VERYLOW
    ),
    opcode_values.SWAP12: as_opcode(
        logic_fn=swap.swap12, mnemonic=mnemonics.SWAP12, gas_cost=constants.GAS_VERYLOW
    ),
    opcode_values.SWAP13: as_opcode(
        logic_fn=swap.swap13, mnemonic=mnemonics.SWAP13, gas_cost=constants.GAS_VERYLOW
    ),
    opcode_values.SWAP14: as_opcode(
        logic_fn=swap.swap14, mnemonic=mnemonics.SWAP14, gas_cost=constants.GAS_VERYLOW
    ),
    opcode_values.SWAP15: as_opcode(
        logic_fn=swap.swap15, mnemonic=mnemonics.SWAP15, gas_cost=constants.GAS_VERYLOW
    ),
    opcode_values.SWAP16: as_opcode(
        logic_fn=swap.swap16, mnemonic=mnemonics.SWAP16, gas_cost=constants.GAS_VERYLOW
    ),
    #
    # Logging
    #
    opcode_values.LOG0: as_opcode(
        logic_fn=logging.log0, mnemonic=mnemonics.LOG0, gas_cost=constants.GAS_LOG
    ),
    opcode_values.LOG1: as_opcode(
        logic_fn=logging.log1, mnemonic=mnemonics.LOG1, gas_cost=constants.GAS_LOG
    ),
    opcode_values.LOG2: as_opcode(
        logic_fn=logging.log2, mnemonic=mnemonics.LOG2, gas_cost=constants.GAS_LOG
    ),
    opcode_values.LOG3: as_opcode(
        logic_fn=logging.log3, mnemonic=mnemonics.LOG3, gas_cost=constants.GAS_LOG
    ),
    opcode_values.LOG4: as_opcode(
        logic_fn=logging.log4, mnemonic=mnemonics.LOG4, gas_cost=constants.GAS_LOG
    ),
    #
    # System
    #
    ...
    opcode_values.CALL: call.Call.configure(
        __name__="opcode:CALL", mnemonic=mnemonics.CALL, gas_cost=constants.GAS_CALL
    )(),
