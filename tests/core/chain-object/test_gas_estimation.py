...
@pytest.mark.parametrize(
    ...
    (
        ...
        pytest.param(
            ...
            TangerineWhistleVM,
            23935,
            id='sha3 precompile 32 bytes 1000_tolerance binary pending for TangerineWhistleVM',
        ),
        pytest.param(
            b'',
            None,
        ...
        pytest.param(
            ...
            SpuriousDragonVM,
            23935,
            id='sha3 precompile 32 bytes 1000_tolerance binary pending for SpuriousDragonVM',
        ),
        pytest.param(
            b'',
            None,
        ...
        pytest.param(
            ...
            ConstantinopleVM,
            23935,
            id='sha3 precompile 32 bytes 1000_tolerance binary pending for ConstantinopleVM',
        ),
        pytest.param(
            b'',
            None,
        ...
        pytest.param(
            ...
            PetersburgVM,
            23935,
            id='sha3 precompile 32 bytes 1000_tolerance binary pending for PetersburgVM',
        ),
        pytest.param(
            b'',
            None,
