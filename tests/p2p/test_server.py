...
# constants copied from tests/p2p/test_auth.py : `test_handshake_eip8()`
test_values = {k: decode_hex(v) for (k, v) in {
    ...
    "initiator_ephemeral": "869d6ecf5211f1cc60418a13b9d870b22959d0c16f02bec714c960dd2298a32d",
    "receiver_ephemeral": "e238eb8e04fee6511ab04c6dd3c89ce097b11f25d584863ac2b6d5b35b1847e4",
...
async def ping_server():
    ...
    asyncio.ensure_future(send_auth_msg_to_server(
        SERVER_ADDRESS, test_values['auth_init_ciphertext'])
    )
