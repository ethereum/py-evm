...
from eth_keys import (
    datatypes as eth_keys_datatypes,
    keys,
)
...
class TrinityPeer(BasePeer):
    ...
    def __init__(self,
                 ...
                 # BasePeer fields
                 remote: Node,
                 privkey: eth_keys_datatypes.PrivateKey,
...
TPeer = TypeVar('TPeer', bound=TrinityPeer)


class TrinityPeerPool(BasePeerPool[TPeer]):
    def __init__(self,
                 headerdb: 'BaseAsyncHeaderDB',
                 network_id: int,
                 vm_configuration: Tuple[Tuple[int, Type[BaseVM]], ...],
        ...
        super().__init__(privkey=privkey, max_peers=max_peers, token=token)
        self.headerdb = headerdb
        self.network_id = network_id
        self.vm_configuration = vm_configuration
    ...
    @property
    def highest_td_peer(self) -> TPeer:
    ...
    def get_peers(self, min_td: int) -> List[TPeer]:
